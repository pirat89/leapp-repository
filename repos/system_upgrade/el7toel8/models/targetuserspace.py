...
@deprecated(since='2020-11-11', message='Replaced by TargetUserSpacePreupgradeTasks.')
class RequiredTargetUserspacePackages(Model):
    topic = TargetUserspaceTopic
    packages = fields.List(fields.String(), default=[])


@deprecated(since='2020-11-11', message='Replaced by TargetUserSpaceInitrdEnvTasks')
